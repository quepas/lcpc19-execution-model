 ...
 */
public class MTimes extends BinaryOp {

    public MTimes(Expression left, Expression right) {
        super("*", left, right);
    }

    @Override
    public <T> T accept(ASTVisitor<T> visitor) throws Exception {
        return visitor.visitMTimes(this);
    }

    @Override
    public void enterRule(ASTListener listener) {
        listener.enterMTimes(this);
    }

    @Override
    public void exitRule(ASTListener listener) {
        listener.exitMTimes(this);
    }
}
