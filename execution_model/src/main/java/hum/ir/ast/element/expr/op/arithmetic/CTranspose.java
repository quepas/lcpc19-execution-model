 ...
 */
public class CTranspose extends UnaryOp {

    public CTranspose(Expression child) {
        super("'", child);
    }
    ...
    public <T> T accept(ASTVisitor<T> visitor) throws Exception {
        return visitor.visitCTranspose(this);
    }

    @Override
    public void enterRule(ASTListener listener) {
        listener.enterCTranspose(this);
    }

    @Override
    public void exitRule(ASTListener listener) {
        listener.exitCTranspose(this);
    }
}
