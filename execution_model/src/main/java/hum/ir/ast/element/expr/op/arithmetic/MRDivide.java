 ...
 */
public class MRDivide extends BinaryOp {

    public MRDivide(Expression left, Expression right) {
        super("/", left, right);
    }

    @Override
    public <T> T accept(ASTVisitor<T> visitor) throws Exception {
        return visitor.visitMRDivide(this);
    }

    @Override
    public void enterRule(ASTListener listener) {
        listener.enterMRDivide(this);
    }

    @Override
    public void exitRule(ASTListener listener) {
        listener.exitMRDivide(this);
    }
}
